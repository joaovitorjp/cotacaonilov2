ALTER TABLE public.links_cotacao
  ADD COLUMN IF NOT EXISTS tipo_preco_mt text NOT NULL DEFAULT 'IPI_ST',
  ADD COLUMN IF NOT EXISTS tipo_preco_go text NOT NULL DEFAULT 'NOTA';

UPDATE public.links_cotacao SET tipo_preco_mt = 'IPI_ST', tipo_preco_go = 'NOTA';
