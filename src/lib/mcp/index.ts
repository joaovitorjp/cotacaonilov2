...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Ferramentas de leitura para o sistema ADR-SYSTEM. Use `list_cotacoes` para ver cotações do usuário, `get_cotacao` para detalhes de uma cotação, `list_fornecedores` para os fornecedores cadastrados e `list_respostas` para respostas de fornecedores a uma cotação. Todos os dados são escopados ao usuário autenticado.",
